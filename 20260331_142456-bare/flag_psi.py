...
FOLDER1_IMGS = sorted(Path("./gap_point/1").glob("*.bmp"))
FOLDER2_IMGS = sorted(Path("./gap_point/2").glob("*.bmp"))
FOLDER4_IMGS = sorted(Path("./gap_point/4").glob("*.bmp"))
FOLDER5_IMGS = sorted(Path("./gap_point/5").glob("*.bmp"))
FOLDER6_IMGS = sorted(Path("./gap_point/6").glob("*.bmp"))
FOLDER7_IMGS = sorted(Path("./gap_point/7").glob("*.bmp"))
...
def find_flag_in_third_image(rois_12, roi3, folder_name=""):
    ...
    plt.figure()
    plt.subplot(1, 2, 1)
    plt.imshow(grad1, cmap='viridis')
    plt.subplot(1, 2, 2)
    plt.imshow(grad2, cmap='viridis')
    plt.show()
...
def main():
    ...
    r4 = analyse_folder(FOLDER4_IMGS, "4")
    r5 = analyse_folder(FOLDER5_IMGS, "5")
    r6 = analyse_folder(FOLDER6_IMGS, "6")
    r7 = analyse_folder(FOLDER7_IMGS, "7")
