...
def process_image(img_name, img_file):
    # ── Load & crop ───────────────────────────────────────────────────────────────
    img_full = np.array(Image.open(img_name).convert('L'))
    ...
    savemat(f'data_{img_file.split('.')[0]}.mat', {'x_center': x_center, 'y_center': y_center, 'z_surface': z_surface})
...
def main():
    ...
    import os
    image_folder = './20260330_215619-bien'
    ...
    for img_file in image_files:
        img_file = '20260330_220056_859.png'
